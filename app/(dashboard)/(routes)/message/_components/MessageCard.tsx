...
const MessageCard = ({msg, user}:Props) => {
    ...
    const dateString = `${date.getHours()}:${date.getMinutes() > 10 ? date.getMinutes() : `0${date.getMinutes()}`} ${isToday ? "" : "||"} ${dayString} `
    return (

            
<div className="flex items-start gap-2.5 w-full mb-4" dir='rtl'>
